...
{
    position:relative;
    background: transparent url('/static_widget_list/assets/images/buttons/regular/green/rightside-regular-btn.png') no-repeat scroll top right;
    display: inline;
    float: left;
...
{
    background: transparent url('/static_widget_list/assets/images/buttons/regular/green/leftside-regular-btn.png') no-repeat;
    display: block;
    line-height: 14px;
...
{
    position:relative;
    background: transparent url('/static_widget_list/assets/images/buttons/small/green/rightside-small-btn.png') no-repeat scroll top right;
    display: inline;
    float: left;
    font: normal 12px arial, sans-serif;
    height: 19px;
...
{
    background: transparent url('/static_widget_list/assets/images/buttons/small/green/leftside-small-btn.png') no-repeat;
    display: block;
    line-height: 8px;
...
.buttonArea
{
   /*background: url("/static_widget_list/assets/images/grad.png") repeat-x scroll 0 0 transparent;*/
...
.summary .header
{
   background: url("/static_widget_list/assets/images/head-gradient.gif") repeat-x scroll 0 0 transparent;
   height:23px;
   font-size:14px;
   font-weight:800;
}
...
.goback
{
   background: url('/static_widget_list/assets/images/share-arrows-24-left.png') no-repeat;
   margin-right: 15px;
   width: 24px;
   height: 19px;
   cursor: pointer;
...
.listContainer table.widget_list tr.widget_list_header, .listContainerPassive table.widget_list tr.widget_list_header
{
   ...
   font-weight:bold;
   height:40px;
   /*background: transparent url('/static_widget_list/assets/images/catbar-bg.png') repeat-x bottom;*/
}
...
.ajaxLoad
{
   background: #737373 url('/static_widget_list/assets/images/list-loader.gif') no-repeat;
...
{
    /*background: url("/static_widget_list/assets/images/th_header.gif") repeat-x scroll left center transparent;  */
    padding: 4px;
    text-align: center;
...
{
    position:relative;
    background: transparent url('/static_widget_list/assets/images/input_text_right.png') no-repeat scroll top right;
    display: inline-block;
    height: 27px;
    line-height: 27px;
    padding-right: 6px;
...
div.inputOuter .inputInner {position:relative;background: transparent url('/static_widget_list/assets/images/input_text_left.png') no-repeat scroll top left;border: none;height: 27px;line-height: 27px;padding-left: 6px;width: auto;padding-right: 7px;}
...
*/
.widget-search-arrow {background: url('/static_widget_list/assets/images/arrow-16.png') no-repeat scroll 0px 0px transparent;float:right;margin:8px;position: relative;right:-23px;top:-30px;cursor:pointer;border:0px solid red;height:20px;width:20px;display:none}
.widget-search-arrow:hover {background: url('/static_widget_list/assets/images/arrow-16.png') no-repeat scroll 0px 0px transparent;}

/**
* Search Ahead Magifier Glass
*/
.widget-search-magnifier {background: url('/static_widget_list/assets/images/search-16.png') no-repeat scroll 0px 0px transparent;float:right;margin:7px;position: relative;right:-13px;top:-30px;cursor:pointer;border:0px solid red;height:20px;width:20px}
.widget-search-magnifier:hover {background: url('/static_widget_list/assets/images/search-16.png') no-repeat scroll 0px 0px transparent}
...
*+html ul#pagination li div.select-outer {background: url("/static_widget_list/assets/images/input_text_right.png") no-repeat scroll right 2px transparent;}
